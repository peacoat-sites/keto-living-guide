...
image: "/img/heroes/34415588.jpg"
categories: ["Macros"]
tags: ["much", "protein", "should", "keto"]
slug: "how-much-protein-should-i-eat-on-keto"
affiliate_disclosure: false
faqs:
 - q: "Will eating too much protein on keto cause insulin spikes that stop fat burning?"
 ...
 - q: "How do I know if I'm eating the right amount of protein?"
   a: "A few indicators: you're maintaining or building muscle while losing fat, your hunger is manageable between meals, you're recovering reasonably from exercise, and you don't feel like you're running on empty. Ketone meters can give you a data point, but chasing high ketone numbers isn't the goal. Body composition changes and energy levels are more meaningful feedback."
 - q: "Should I count protein from both food and supplements the same way?"
   a: "Yes. Protein is protein from a macronutrient standpoint. Where it comes from matters for amino acid quality and digestion, but your daily gram target doesn't change based on whether those grams come from a chicken breast or a protein shake. Track total daily protein regardless of source."
 - q: "Does protein need change if I'm doing intermittent fasting alongside keto?"
...
Forget percentages for protein. Calculating protein as a percentage of calories is how you end up with wildly different gram targets depending on whether you're eating 1,600 or 2,400 calories. Protein needs are tied to your body and your activity, not your total energy intake.

Use lean body mass or goal body weight as your anchor instead.

**For most sedentary to lightly active adults:** 0.7 to 1.0 grams of protein per pound of goal body weight per day is a reasonable starting range.

**For active people, athletes, or those doing resistance training:** 1.0 to 1.2 grams per pound of lean body mass is better supported. Some research suggests going higher, up to 1.6g per pound, doesn't impair ketosis and improves body composition outcomes.

**For people over 50:** Lean toward the higher end of these ranges. Muscle protein synthesis becomes less efficient with age, a concept called anabolic resistance, which means you need more dietary protein to produce the same muscle-building signal as a younger person.
...
If you don't know your body fat percentage, use your goal body weight as a reasonable proxy. Don't use your current weight if you're significantly above where you want to be.

**Step 2: Choose your multiplier.**
- Sedentary/light activity: 0.7g per pound
- Moderate activity (3-4x/week exercise): 0.85-1.0g per pound
- Heavy training, athletic performance, or over 50: 1.0-1.2g per pound

**Step 3: Calculate your daily gram target.**
Goal weight x multiplier = daily protein grams. Write this number down. Make it your anchor.

**Step 4: Distribute across meals.**
Research on muscle protein synthesis, particularly from Layman and colleagues, suggests spreading protein across 3-4 meals of roughly 30-40g each is more effective than front-loading or back-loading. This matters especially if body composition is a goal.

**Step 5: Track for two weeks, then calibrate.**
Log your actual intake against your target. Adjust based on how you feel, how hunger is, and whether you're maintaining muscle and losing fat at the rate you expect. Ketone levels alone are a poor guide to whether your protein intake is optimized.
...
## Protein Quality: Not All Sources Are Equal on Keto

Hitting your gram target matters. So does what you're hitting it with.

Animal proteins (beef, eggs, fish, poultry, dairy) contain all essential amino acids in proportions your body can readily use. They score high on measures like the Protein Digestibility-Corrected Amino Acid Score (PDCAAS) and the Digestible Indispensable Amino Acid Score (DIAAS). For keto specifically, these sources also come with zero or negligible carbs, which makes them structurally compatible.

A quick ranking of protein sources by practical value on keto:

| Protein Source | Protein per 100g | Net Carbs | Notes |
|---|---|---|---|
| Chicken breast | ~31g | 0g | Lean, versatile, affordable |
| Canned tuna | ~25g | 0g | Convenient, underrated |
| Eggs (whole) | ~13g | 0.6g | Complete amino profile, easy prep |
| Beef (85% lean) | ~26g | 0g | Higher fat, satiating |
| Salmon | ~25g | 0g | Excellent omega-3 profile |
| Greek yogurt (full-fat) | ~10g | ~4g | Watch carb creep |
| Cottage cheese (full-fat) | ~12g | ~3g | Decent option, moderate carbs |
| Whey protein isolate | ~25g per scoop | ~1-2g | Useful for convenience |

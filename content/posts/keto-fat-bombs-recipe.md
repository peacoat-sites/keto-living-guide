...
faqs:
  - q: "How many fat bombs should I eat per day?"
    a: "One to three is a reasonable range for most people using them as a between-meal snack or a way to top off fat macros. The right number depends on your total daily calorie and fat targets, which vary significantly by individual. If weight loss is your goal, count them in your daily totals rather than treating them as extras. A consultation with a registered dietitian can help you set targets specific to your situation."
  - q: "Can I make fat bombs without coconut oil?"
    a: "Yes, and sometimes you should. Butter, cacao butter, and cream cheese all work as bases or partial substitutes. Cacao butter in particular creates a firmer, smoother chocolate-style fat bomb that holds up better at room temperature than coconut oil versions."
  - q: "Why are my fat bombs too soft?"
    a: "Either the fat ratio is off, you haven't chilled them long enough, or you're using a fat that doesn't firm well (like MCT oil). Try increasing your solid fat component, reducing any liquid add-ins, and giving them more time in the freezer. If you're using coconut oil and they're still soft in the fridge, switch to the freezer."
  - q: "Do fat bombs break a fast?"
...
## What Fat Bombs Are Actually For
...
### Savory Herb and Cream Cheese Bites

Most people skip savory fat bombs entirely, and they're missing out. These are more filling than sweet versions and work better alongside a meal to round out fat macros.
...
- Optional: 2 tbsp crumbled bacon

**Steps:**

1. Beat cream cheese and butter together until completely smooth. A hand mixer saves time here.
2. Fold in chives, garlic, paprika, salt, and pepper.
3. Taste and adjust seasoning. It should be punchy, not bland.
4. Roll into balls roughly the size of a large marble (about 1.5 tablespoons each).
5. If using bacon, roll the outside of each ball in crumbled bacon before refrigerating.
6. Refrigerate on a parchment-lined tray for at least 1 hour before serving.
7. Store in an airtight container in the fridge for up to 5 days.

Approximate macros per piece: 5g fat, 1g protein, less than 1g net carbs.

### Dark Chocolate Almond Freezer Bites

This is the sweet version that doesn't taste like a Halloween candy knockoff.
...
- 2 tbsp allulose or erythritol blend
- 1 tsp vanilla extract
- Pinch of sea salt
- Optional: 1 tbsp chia seeds for texture and satiety
...
Approximate macros per piece: 8g fat, 1.5g protein, 1g net carbs.
...
|---|---|---|---|---|
| Coconut oil | Moderate | Low (melts easily) | Strong | Frozen recipes |
| Butter | High | Moderate | Neutral | Refrigerated bites |
| Cream cheese | High | Good | Neutral to rich | Savory or no-bake |
| MCT oil | Low | Very low | Neutral | Blended into other bases |
| Cacao butter | Moderate | High | Mild chocolate | Chocolate shell recipes |

...
**Try** swapping your side salad for a full 3-cup base of mixed greens and track how your energy and digestion shift over two weeks, then check out our [low-carb meal planning guide](/low-carb-meal-planning) for building this into your weekly routine.
...
**Get** a [kitchen scale like the OXO Good Grips 11-pound model](https://www.amazon.com) (around $50, and the site may earn a commission) so you can actually weigh your greens rather than estimating cups, which turns out to be wildly inconsistent in practice.
...
**Client working strict keto for epilepsy management (20g net carb limit) → Added 2 cups cooked spinach and 1 cup arugula daily, cooked in olive oil → Brought magnesium intake from ~140mg/day to ~320mg/day, which resolved nighttime cramps within 10 days without adding a separate supplement.**

**Client eating "lazy keto" averaging 40g net carbs, complained of constant fatigue → Replaced processed keto snack bars (averaging 8g net carbs each, two per day) with a large wilted kale and olive oil side dish → Net carbs stayed similar, but potassium and folate intake doubled, energy improved noticeably by week three.**

**New keto adopter trying to avoid vegetables entirely, following a strict carnivore-adjacent approach for 60 days → Developed significant constipation and came back with borderline low serum magnesium → Reintroducing 3 cups mixed greens daily resolved constipation within one week and brought magnesium levels back into normal range at the next blood draw.**

The pattern is consistent. Greens punch above their carb weight.

**Build** a simple weekly rotation of four or five greens to prevent palate fatigue, and [start with our keto-friendly grocery list](/keto-grocery-list) to map out your first week.
...
- USDA FoodData Central (current): [fdc.nal.usda.gov](https://fdc.nal.usda.gov). Used for all net carb, magnesium, and potassium figures cited in this article.
